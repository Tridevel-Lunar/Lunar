...
export default function Register() {
  ...
  return (
    <AuthShell title="สมัครสมาชิก" subtitle="เปิดบัญชีฟรี แล้วเริ่มเรียนรู้ ทดลองภารกิจ และพัฒนาไอเดียของคุณ">
      ...
      <GoogleSignInButton buttonText="signup_with" onError={setError} />

      <p className="mt-5 text-[0.85rem] text-muted">
        มีบัญชีแล้ว?{" "}
        <Link to="/login" className="text-cyan no-underline transition-[text-shadow] hover:text-glow-cyan-link">
          เข้าสู่ระบบ
        </Link>
      </p>
    </AuthShell>
