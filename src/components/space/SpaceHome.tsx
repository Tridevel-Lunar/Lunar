...
import { CURRENT_COURSE, SPACE_TOPICS } from "./space-data";
        ...
        <main className="relative min-h-0 flex-1 overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(to right, rgba(3,8,18,0.94) 0%, rgba(3,8,18,0.7) 30%, rgba(3,8,18,0.15) 60%, transparent 80%)",
            ...
            <div
              className="absolute inset-0 transition-opacity duration-700 ease-in-out"
              style={{
                background: "linear-gradient(to left, rgba(3,8,18,0.94) 0%, rgba(3,8,18,0.7) 30%, rgba(3,8,18,0.15) 60%, transparent 80%)",
...
function HomeView({ onGoToCourses }: { onGoToCourses: () => void }) {
  return (
    <div className="flex h-full flex-col justify-center px-8 py-10 max-w-xl">
      ...
      <p className="mb-6 max-w-[480px] text-[0.92rem] leading-relaxed text-text/65">
        ปูพื้นฐานวิศวกรรมอวกาศด้วยบทเรียนแบบ Interactive
        ตั้งแต่โครงสร้าง CubeSat ระบบฝังตัว ฟิสิกส์วงโคจร ไปจนถึงการเขียนโปรแกรมควบคุม autopilot
        ครบจบในโมดูลเดียว
      </p>
      <div>
        <button
...
function CoursesView() {
  return (
    <div className="flex h-full flex-col justify-center px-8 py-10 ml-auto max-w-xl">
