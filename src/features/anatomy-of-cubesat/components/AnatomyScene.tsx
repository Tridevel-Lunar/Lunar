...
import CubeSatOverviewModel from "@/features/anatomy-of-cubesat/components/CubeSatOverviewModel";
import StructureFrame from "@/features/anatomy-of-cubesat/components/StructureFrame";
import SubsystemStack from "@/features/anatomy-of-cubesat/components/SubsystemStack";
import DataFlowLinks from "@/features/anatomy-of-cubesat/components/DataFlowLinks";
import { easeInOutCubic, lerp } from "@/features/anatomy-of-cubesat/lib/layout";
import { stepToViewMode, type AnatomyStep } from "@/features/anatomy-of-cubesat/lib/lesson";
...
function SceneRig({
  ...
  return (
    <>
      ...
      <ambientLight intensity={flat ? 0.7 : 0.38} />
      <directionalLight
        position={flat ? [0, 10, 0] : [4, 6, 3]}
        intensity={flat ? 0.85 : 1.35}
        castShadow={!flat}
        shadow-mapSize={[1024, 1024]}
      />
      {!flat && (
        <>
          <directionalLight position={[-3, 2, -4]} intensity={0.45} color="#7dd3fc" />
          <pointLight position={[0, -2, 2]} intensity={0.35} color="#00e5ff" />
